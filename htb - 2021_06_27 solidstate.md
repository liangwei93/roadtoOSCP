...
SF-Port4555-TCP:V=7.91%I=7%D=6/26%Time=60D7EEA4%P=x86_64-pc-linux-gnu%r(Ge
...
according to 35513.py script, it uses a default credential of root:root
just try nc to 4555 with the credential

go change password for all of them lmao then check their mail
...
get in and get user.txt (-t rbash . This will run bash on connect instead of the assigned shell. )

look at the james 2.3.2 exploit and follow
